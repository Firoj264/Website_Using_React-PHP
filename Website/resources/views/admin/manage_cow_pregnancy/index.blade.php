...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-success">
            <div class="box-header with-border" align="right"> <a href="{{url('managecowpregnancy/create')}}" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i> <b>Add New</b> </a> <a href="#" class="btn btn-warning btn-sm"> <i class="fa fa-refresh"></i> <b>Refresh</b> </a> </div>
            <div class="box-body">
                <div class="col-sm-12">
                        ...
                        <table class="table table-bordered table-striped table-responsive">
                            ...
                            @foreach($data as $key => $rows)
                                <tr>
                                    ...
                                    <td>{{$rows->approximate_dalivery_date}}</td>
                                    <td>{{$rows->note}}</td>
                                    <td>
