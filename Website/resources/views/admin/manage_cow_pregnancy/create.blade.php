                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="semen_push_date" id="semen_push_date" class="form-control wsit_datepicker" autocomplete="off" value="" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="date">Pregnancy Start Date <span class="validate">*</span> : </label>
                                            <input id="pregnancy_start_date" type="text" name="pregnancy_start_date" autocomplete="off" class="form-control wsit_datepicker wsit_datepicker_calc_p_date" value="" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
