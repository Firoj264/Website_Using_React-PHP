    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-success">
                {!! Form::open(['url' => ['/managecowpregnancy',$data->id], 'method' =>'POST', 'id'=>'validate','class'=>'formsave','enctype'=>"multipart/form-data"]) !!}
                @csrf
                <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="semen_push_date" id="semen_push_date" class="form-control wsit_datepicker" value="{{$data->semen_push_date}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="date">Pregnancy Start Date <span class="validate">*</span> : </label>
                                            <input id="pregnancy_start_date" type="text" name="pregnancy_start_date" class="form-control wsit_datepicker wsit_datepicker_calc_p_date" value="{{$data->pregnancy_start_date}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
