...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border" align="right"> <a href="{{url('employeesalary/create')}}" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i> <b>Add User</b> </a> <a href="#" class="btn btn-warning btn-sm"> <i class="fa fa-refresh"></i> <b>Refresh</b> </a> </div>
            <div class="box-body">
                @if(session('message'))
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$key+1}}</td>
                                <td class="col-sm-1"><img width="80%" src="{{ URL::asset($rows->image) }}"></td>
