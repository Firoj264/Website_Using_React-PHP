...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-tasks" aria-hidden="true"></i> Stall List</h1>
        <ol class="breadcrumb">
                ...
                <div class="table_scroll">
                    ...
                    <table class="table table-bordered table-striped table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><label class="label label-default lblfarm">{{$key+1}}</label></td>
                                <td>{{$rows->stall_no}}</td>
                                @if($rows->status > $rows->max_availity)
                                ...
                                <td>
                                    ...
                                    {!! Form::open(['method' => 'DELETE','url' => ['stall', $rows->id],'style'=>'display:inline']) !!}
