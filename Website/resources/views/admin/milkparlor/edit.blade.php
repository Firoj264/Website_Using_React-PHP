...
<div class="wrapper">
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><i class="icon-user-follow"></i> Collect Milk</h1>
            <ol class="breadcrumb">
                ...
                <div class="box-body">
                    <div class="col-sm-6 col-sm-offset-3">
                        <div class="panel panel-default">
                            <div class="panel-heading"><i class="icon-list"></i>&nbsp;Milk collected Information:</div>
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="date" name="collectDate" id="collectDate" class="form-control" value="{{$data->collected_date}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <a href="{{url('colletedmilklist')}}" class="btn btn-info" id="list">List</a>
                                </div>
                            </div>
                        </div>
                    </div>
