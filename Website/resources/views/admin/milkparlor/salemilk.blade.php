...
<div class="wrapper">
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1><i class="icon-user-follow"></i> Sale Milk</h1>
            <ol class="breadcrumb">
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-default">
                            <div class="panel-heading"><i class="icon-list"></i>&nbsp;Sale Milk :</div>
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="accNo" class="form-control" id="accNo">
                                            ...
                                            @foreach($data as $row)
                                            <option value="{{$row->account_no}}">{{$row->account_no}} [Collected Milk : {{$row->liter}} Litre]</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label" for="contact">Mobile No : <span class="validate">*</span></label>
                                    <div class="col-md-8">
                                        <input type="text" name="contact" id="contact" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label" for="contact">Sale Date : <span class="validate">*</span></label>
                                    <div class="col-md-8">
                                        <input type="date" name="sale_date" id="sale_date" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label" for="email">Email : <span class="validate">*</span></label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="litre" id="litre" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label" for="pricelitre">Price/Litre :</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label" for="total">Total :</label>
                                    <div class="col-md-8">
                                        <input type="text" name="total" id="total" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label" for="paid">Paid : <span class="validate">*</span></label>
                                    <div class="col-md-8">
                                        <input type="text" name="paid" id="paid" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label" for="due">Due :</label>
                                    <div class="col-md-8">
