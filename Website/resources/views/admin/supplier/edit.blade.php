                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="supplier_name" id="supplier_name" class="form-control" value="{{$data->supplier_name}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label" for="company_name">Company Name : <span class="validate">*</span></label>
                                    <div class="col-md-8">
                                        <input type="text" name="company_name" class="form-control" id="company_name" value="{{$data->company_name}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" id="imageBlock">
                                <div class="staffimagebox">
                                    <div class="select_image"> <img src="{{url('frontend/images/staff.png')}}" id="image" style="width: 260px; height:280px;"> </div>
