            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <button type="submit" class="btn btn-success " id="saveInfo"><i class="fa fa-floppy-o"></i> <b>Update Information</b></button>
                            &nbsp;
                            <a href="{{url('staff')}}" class="btn btn-warning "><i class="fa fa-list" aria-hidden="true"></i> <b> List</b></a> </div>
