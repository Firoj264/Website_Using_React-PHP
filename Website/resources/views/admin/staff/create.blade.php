                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="phone_number" class="form-control" id="phone_number" value="" placeholder="Enter phone number">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label" for="nid">NID :<span class="validate">*</span></label>
                                    <div class="col-md-8">
                                        <input type="text" name="nid" class="form-control isnumber" id="nid" placeholder="Enter your NID Number">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="joining_date" class="form-control wsit_datepicker" id="joining_date" placeholder="Enter Joining Date" value="">
                                    </div>
                                </div>
                            </div>
                        </div>
