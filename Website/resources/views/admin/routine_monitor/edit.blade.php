                                    ...
                                    <div class="col-md-9">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="weight" type="text" name="weight" id="weight" class="form-control decimal" value="" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="height">Animal Updated Height (INCH) <span class="validate">*</span> : </label>
                                                <input id="height" type="text" name="height" id="height" class="form-control decimal" value="" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="milk">Animal Updated Milk Per Day(LTR) : </label>
                                                <input id="milk" type="text" name="milk_per_day" id="milk_per_day" class="form-control decimal" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="date">Monitoring Date <span class="validate">*</span> : </label>
                                                <input id="date" type="text" name="date" class="form-control wsit_datepicker" value="" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
